\documentclass[oneside,english,brazil]{ifmgtex}
...
\include{resumo_abstract}                % Resumo e Abstract (Obrigatórios)
...
\input{capitulos/configuracao_pre}

\chapter{Corpos Flutuantes}

\input{capitulos/corpos_flutuantes}

\chapter{Ambientes Matemáticos}

\input{capitulos/ambientes_matematicos}

\chapter{Ferramentas Úteis} \label{capitulo:ferramentas_uteis}

\input{capitulos/ferramentas_uteis}

\chapter{Citações e Referências}

\input{capitulos/citacoes_referencias}
...
\input{apendices/doc_basico_ifmg}
