...
O requisito básico para utilização da classe {IF\TeX} é criar um documento com o comando \comando{documentclass\{iftex\}}.
Por padrão, a classe {IF\TeX}, cria um documento frente e verso.
Para documentos somente com anverso, é necessário informar a opção \textbf{onseside} (comando \comando{documentclass[oneside]\{iftex\}}).
